(() => {
    ...
    registry.register('instagram', {
        ...
        inputSelector:
            'main form textarea, main form [contenteditable="true"], main [role="textbox"][contenteditable="true"], main [contenteditable="true"][role="textbox"], div[contenteditable="true"][role="textbox"], div[contenteditable="true"]',
        uiPlacement: 'overlay',
        profileContainerSelector: 'main header, header',
        otherPersonNameSelector:
            'h2 span[title], main header span[title], header span[title], header h1, header h2, header [dir="auto"]',
